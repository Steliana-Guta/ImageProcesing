...
dim = [0.1 0.8 0.8 0]; % dimensions of annotation box 
imshow(RGBboundaries) % displaying image 

% plotting viasulas for the above calculations 
hold on
...
annotation('textbox',dim,'String',str,'FitBoxToText','on','EdgeColor','black','Color','black'); % creating the annotation box
hold off
